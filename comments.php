...
if ('comments.php' == basename($_SERVER['SCRIPT_FILENAME'])) {
    die('Ne pas t&eacute;l&eacute;charger cette page directement, merci !');
}
...
<label for="author"><small>Nom <?php if ($req) {
    echo "(requis)";
} ?></small></label></p>

<p><input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="40" tabindex="2" />
<label for="email"><small>email (ne sera pas publi&eacute;) <?php if ($req) {
    echo "(requis)";
} ?></small></label></p>
